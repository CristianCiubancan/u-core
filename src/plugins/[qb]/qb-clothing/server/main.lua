...
-- openMenu so the first 'open' message ships translations in the right
-- language. EnsurePlayerLocale is cache → DB → default; warm because
-- PlayerLoaded fired during loadUserData earlier in the login flow.
QBCore.Functions.CreateCallback('qb-clothing:server:getLocale', function(source, cb)
