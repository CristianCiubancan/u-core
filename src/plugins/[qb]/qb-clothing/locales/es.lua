local Translations = {
    ...
    ui = {
        ...
        -- u-core: nuevas claves usadas solo por el UI de React. Se
        -- traducen por idioma porque Lang:replace() no preserva la
        -- cadena de fallback de Polyglot.
        outfit_name_hint = "Elige un nombre para guardar este atuendo.",
        outfit_name_required = "Nombre requerido",
        no_room_outfits = "Sin atuendos preestablecidos",
        no_saved_outfits = "Sin atuendos guardados",
        cam_full = "Cuerpo entero",
        cam_face = "Cara",
        cam_torso = "Torso",
        cam_legs = "Piernas",
