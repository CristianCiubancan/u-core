local Translations = {
    ...
    ui = {
        ...
        -- u-core: nieuwe sleutels alleen voor de React-UI. Per taal
        -- vertaald omdat Lang:replace() de Polyglot-fallback-keten
        -- niet behoudt.
        outfit_name_hint = "Kies een naam om deze outfit op te slaan.",
        outfit_name_required = "Naam vereist",
        no_room_outfits = "Geen presets beschikbaar",
        no_saved_outfits = "Geen opgeslagen outfits",
        cam_full = "Volledig",
        cam_face = "Gezicht",
        cam_torso = "Bovenlichaam",
        cam_legs = "Benen",
        rotate_left = "Draai links",
        rotate_right = "Draai rechts"
    },
