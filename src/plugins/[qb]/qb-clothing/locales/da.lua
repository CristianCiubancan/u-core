local Translations = {
    ...
    ui = {
        ...
        -- u-core: nye nøgler kun til React-UI'en. Pr. sprog oversat,
        -- fordi Lang:replace() ikke bevarer Polyglots fallback-kæde.
        outfit_name_hint = "Vælg et navn at gemme dette outfit under.",
        outfit_name_required = "Navn påkrævet",
        no_room_outfits = "Ingen forudindstillede outfits",
        no_saved_outfits = "Ingen gemte outfits",
        cam_full = "Helkrop",
        cam_face = "Ansigt",
        cam_torso = "Overkrop",
        cam_legs = "Ben",
        rotate_left = "Drej venstre",
        rotate_right = "Drej højre"
    },
