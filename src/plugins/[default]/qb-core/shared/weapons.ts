// Direct port of qb-core/shared/weapons.lua. Drop-in for
// `QBCore.Shared.Weapons` consumers (qb-policejob, qb-ambulancejob,
// qb-weapons, qb-log, etc.).
//
// Lua's source uses backtick syntax (`weapon_unarmed`) which Lua 5.4
// expands to the GTA5 integer hash at compile time, so the Lua table
// is keyed by hash. We can't do that at TS compile time — but the
// hash is just `GetHashKey(name)`, which the FiveM client/server
// runtime can compute.
//
// This file exports the data as a string-keyed record. The Phase-2
// server/client wiring will build a hash-keyed map at module load by
// calling GetHashKey() on each name, so existing consumers indexing
// by `Weapons[hash]` still work.
...
export interface Weapon {
  ...
  /** Ammo bucket the weapon draws from. `null` for melee, throwables,
   *  and damage-tracking pseudo-weapons (drowning, fall, etc.). */
...
export const Weapons: Record<string, Weapon> = {
  // Melee
  weapon_unarmed: { name: 'weapon_unarmed', label: 'Fists', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_dagger: { name: 'weapon_dagger', label: 'Dagger', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_bat: { name: 'weapon_bat', label: 'Bat', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_bottle: { name: 'weapon_bottle', label: 'Broken Bottle', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_crowbar: { name: 'weapon_crowbar', label: 'Crowbar', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_flashlight: { name: 'weapon_flashlight', label: 'Flashlight', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_golfclub: { name: 'weapon_golfclub', label: 'Golfclub', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_hammer: { name: 'weapon_hammer', label: 'Hammer', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_hatchet: { name: 'weapon_hatchet', label: 'Hatchet', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_knuckle: { name: 'weapon_knuckle', label: 'Knuckle', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_knife: { name: 'weapon_knife', label: 'Knife', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_machete: { name: 'weapon_machete', label: 'Machete', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_switchblade: { name: 'weapon_switchblade', label: 'Switchblade', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_nightstick: { name: 'weapon_nightstick', label: 'Nightstick', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_wrench: { name: 'weapon_wrench', label: 'Wrench', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_battleaxe: { name: 'weapon_battleaxe', label: 'Battle Axe', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_poolcue: { name: 'weapon_poolcue', label: 'Poolcue', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_briefcase: { name: 'weapon_briefcase', label: 'Briefcase', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_briefcase_02: { name: 'weapon_briefcase_02', label: 'Briefcase', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_garbagebag: { name: 'weapon_garbagebag', label: 'Garbage Bag', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_handcuffs: { name: 'weapon_handcuffs', label: 'Handcuffs', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_bread: { name: 'weapon_bread', label: 'Baquette', weapontype: 'Melee', ammotype: null, damagereason: 'Melee killed / Whacked / Executed / Beat down / Murdered / Battered' },
  weapon_stone_hatchet: { name: 'weapon_stone_hatchet', label: 'Stone Hatchet', weapontype: 'Melee', ammotype: null, damagereason: 'Knifed / Stabbed / Eviscerated' },
  weapon_candycane: { name: 'weapon_candycane', label: 'Candy Cane', weapontype: 'Melee', ammotype: null, damagereason: 'Melee Killed / Whacked / Executed / Beat down / Musrdered / Battered / Candy Caned' },
  ...
  weapon_firework: { name: 'weapon_firework', label: 'Firework Launcher', weapontype: 'Heavy Weapons', ammotype: null, damagereason: 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated' },
  weapon_railgun: { name: 'weapon_railgun', label: 'Railgun', weapontype: 'Heavy Weapons', ammotype: null, damagereason: 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated' },
  weapon_railgunxm3: { name: 'weapon_railgunxm3', label: 'Railgun XM3', weapontype: 'Heavy Weapons', ammotype: null, damagereason: 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated' },
  ...
  weapon_compactlauncher: { name: 'weapon_compactlauncher', label: 'Compact Launcher', weapontype: 'Heavy Weapons', ammotype: null, damagereason: 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated' },
  ...
  // Throwables
  weapon_grenade: { name: 'weapon_grenade', label: 'Grenade', weapontype: 'Throwable', ammotype: null, damagereason: 'Bombed / Exploded / Detonated / Blew up' },
  weapon_bzgas: { name: 'weapon_bzgas', label: 'BZ Gas', weapontype: 'Throwable', ammotype: null, damagereason: 'Died' },
  weapon_molotov: { name: 'weapon_molotov', label: 'Molotov', weapontype: 'Throwable', ammotype: null, damagereason: 'Torched / Flambeed / Barbecued' },
  weapon_stickybomb: { name: 'weapon_stickybomb', label: 'C4', weapontype: 'Throwable', ammotype: null, damagereason: 'Bombed / Exploded / Detonated / Blew up' },
  weapon_proxmine: { name: 'weapon_proxmine', label: 'Proxmine Grenade', weapontype: 'Throwable', ammotype: null, damagereason: 'Bombed / Exploded / Detonated / Blew up' },
  weapon_snowball: { name: 'weapon_snowball', label: 'Snowball', weapontype: 'Throwable', ammotype: null, damagereason: 'Died' },
  weapon_pipebomb: { name: 'weapon_pipebomb', label: 'Pipe Bomb', weapontype: 'Throwable', ammotype: null, damagereason: 'Bombed / Exploded / Detonated / Blew up' },
  weapon_ball: { name: 'weapon_ball', label: 'Ball', weapontype: 'Throwable', ammotype: 'AMMO_BALL', damagereason: 'Died' },
  weapon_smokegrenade: { name: 'weapon_smokegrenade', label: 'Smoke Grenade', weapontype: 'Throwable', ammotype: null, damagereason: 'Died' },
  ...
  gadget_parachute: { name: 'gadget_parachute', label: 'Parachute', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  weapon_fireextinguisher: { name: 'weapon_fireextinguisher', label: 'Fire Extinguisher', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  ...
  weapon_barbed_wire: { name: 'weapon_barbed_wire', label: 'Barbed Wire', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Prodded' },
  weapon_drowning: { name: 'weapon_drowning', label: 'Drowning', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  weapon_drowning_in_vehicle: { name: 'weapon_drowning_in_vehicle', label: 'Drowning in a Vehicle', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  weapon_bleeding: { name: 'weapon_bleeding', label: 'Bleeding', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Bled out' },
  weapon_electric_fence: { name: 'weapon_electric_fence', label: 'Electric Fence', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Fried' },
  weapon_explosion: { name: 'weapon_explosion', label: 'Explosion', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Killed / Exploded / Obliterated / Destroyed / Erased / Annihilated' },
  weapon_fall: { name: 'weapon_fall', label: 'Fall', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Committed suicide' },
  weapon_exhaustion: { name: 'weapon_exhaustion', label: 'Exhaustion', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  weapon_hit_by_water_cannon: { name: 'weapon_hit_by_water_cannon', label: 'Water Cannon', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Died' },
  weapon_rammed_by_car: { name: 'weapon_rammed_by_car', label: 'Rammed - Vehicle', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Flattened / Ran over / Ran down' },
  weapon_run_over_by_car: { name: 'weapon_run_over_by_car', label: 'Run Over - Vehicle', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Flattened / Ran over / Ran down' },
  weapon_heli_crash: { name: 'weapon_heli_crash', label: 'Heli Crash', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Helicopter Crash' },
  weapon_fire: { name: 'weapon_fire', label: 'Fire', weapontype: 'Miscellaneous', ammotype: null, damagereason: 'Torched / Flambeed / Barbecued' },

  // Animals
  weapon_animal: { name: 'weapon_animal', label: 'Animal', weapontype: 'Animals', ammotype: null, damagereason: 'Mauled' },
  weapon_cougar: { name: 'weapon_cougar', label: 'Cougar', weapontype: 'Animals', ammotype: null, damagereason: 'Mauled' },
};
